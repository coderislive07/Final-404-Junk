...
import BCMap from "../components/BCMap"
...
export default function Locations() {
  const cities = [
    ...
    },
    {
      ...
      featured: true,
      description: "Eco-conscious junk disposal in Langley and nearby areas.",
      services: ["Residential", "Commercial", "Construction"],
    ...
    },
    {
      ...
      services: ["Residential", "Commercial"],
      coordinates: { lat: 49.32, lng: -123.0736 },
    },
    {
      name: "West Vancouver",
      province: "BC",
    ...
    },
    {
      ...
      featured: false,
      description: "Growing our reach in the quiet town of Pitt Meadows.",
    ...
    },
    {
      ...
      services: ["Residential"],
      coordinates: { lat: 49.0124, lng: -123.082 },
    },
  ]
  ...
  const stats = [
    { icon: MapPin, label: "Cities Served", value: "13" },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center space-x-2 bg-green-600/20 border border-green-600/30 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-green-400 font-medium">Serving Communities Across British Columbia</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent">
              Our Service Locations
            </h1>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Proudly serving the Greater Vancouver Area and surrounding communities with reliable, weight-based junk
              removal services.
            </p>
          </div>
      ...
      <section className="py-16 bg-gray-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Interactive Service Map</h2>
            <p className="text-gray-400 mb-2">Explore our service coverage across British Columbia</p>
            <p className="text-gray-500 text-sm">
              Click on any city marker to view detailed service information and book instantly
            </p>
          </div>
      ...
      <section className="py-16 bg-gray-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400">Complete coverage across the Greater Vancouver Area</p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-gradient-to-r from-green-600/10 to-blue-600/10 border border-green-600/30 rounded-2xl p-8">
            ...
            <p className="text-gray-400 mb-6 text-lg">
              We're rapidly expanding across British Columbia! If your city isn't listed, let us know and we'll
              prioritize bringing our weight-based pricing model to your area.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="border border-gray-600 hover:border-green-400 text-gray-300 hover:text-green-400 px-8 py-3 rounded-full font-semibent transition-colors">
                Contact Us
              </button>
            </div>
          </div>
